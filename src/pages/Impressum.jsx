    ...
    <div className="flex min-h-screen flex-col">
      ...
      <div className="mx-auto w-full max-w-prose flex-1 px-6 py-12">
        ...
        <Block title="Responsible for this website">
          <Line l="Project" v="Passage — a student hackathon prototype (B-Hack Baltic Sea Region 2026, Group 6)" />
        ...
        <Block title="Nature of this site">
          <p className="text-[14px] leading-relaxed text-ink2">
            Passage is a non-commercial, educational prototype built for a hackathon. It provides general, sourced
