...
export const JURISDICTIONS = [
  {
    ...
    claims: {
      ...
      disability_rights: { o: 2, short: 'Strong (ADA)', statement: 'The Americans with Disabilities Act gives strong protection — but the US has signed, not ratified, the UN CRPD.', ev: 'law', cert: 'established', asOf: '2025', src: { org: 'ADA.gov', url: 'https://www.ada.gov/' } },
      ...
      student_work: { required: false, timing: 'on-campus only, ≤20 hrs/week in term', statement: 'F-1 students may work on-campus up to 20 hrs/week; off-campus work needs CPT/OPT authorisation.', ev: 'law', cert: 'established', asOf: '2025', src: { org: 'US SEVP', url: 'https://studyinthestates.dhs.gov/students-and-employment' } },
      health_insurance: { required: true, timing: 'before enrolment', statement: 'Not federally required, but most universities make health insurance a condition of enrolment.', ev: 'practice', cert: 'limited', asOf: '2025', src: { org: 'University requirement', url: '' } },
...

  {
    ...
    claims: {
      ...
      disability_rights: { o: 2, short: 'Strong', statement: 'The 2015 Inclusion of Persons with Disabilities Act (LBI) is broad; Brazil ratified the CRPD in 2008.', ev: 'law', cert: 'established', asOf: '2015', src: 'uncrpd' },
      ...
      cannabis: { o: 1, short: 'Illegal', statement: 'Illegal; personal possession is not jailed but there is no fixed legal amount, leaving it to police discretion.', ev: 'law', cert: 'limited', asOf: '2025', src: { org: 'STF / Lei 11.343', url: '' } },
      ...
      health_insurance: { required: true, timing: 'before visa / enrolment', statement: 'Proof of health coverage is commonly required for the student visa and enrolment.', ev: 'practice', cert: 'limited', asOf: '2025', src: { org: 'Consular requirement', url: '' } },
...

  {
    ...
    claims: {
      ...
      disability_rights: { o: 2, short: 'Strong', statement: 'Germany ratified the CRPD in 2009 and has a strong accessibility and inclusion framework.', ev: 'law', cert: 'established', asOf: '2025', src: 'uncrpd' },
...

  {
    ...
    claims: {
      ...
      disability_rights: { o: 2, short: 'Strong', statement: 'Norway ratified the CRPD in 2013 and has strong welfare and accessibility standards.', ev: 'law', cert: 'established', asOf: '2025', src: 'uncrpd' },
      ...
      cannabis: { o: 1, short: 'Illegal', statement: 'Illegal; small-amount personal use is treated leniently, but sale and possession remain offences.', ev: 'law', cert: 'limited', asOf: '2025', src: { org: 'Norwegian law', url: '' } },
      religious_freedom: { o: 3, short: 'Low restrictions', statement: 'Pew rates government restrictions on religion as low.', ev: 'index', cert: 'established', asOf: '2022', src: 'pew' },
...

  {
    ...
    claims: {
      ...
      antidiscrimination: { o: 1, short: 'Partial', statement: 'The Constitution guarantees equality, but there is no comprehensive anti-discrimination law and enforcement is uneven.', ev: 'law', cert: 'limited', asOf: '2025', src: { org: 'Constitution of Kenya', url: '' } },
      disability_rights: { o: 1, short: 'CRPD + basic law', statement: 'Kenya ratified the CRPD in 2008 and has a Persons with Disabilities Act, but physical access is limited.', ev: 'law', cert: 'established', asOf: '2025', src: 'uncrpd' },
      ...
      cannabis: { o: 0, short: 'Illegal — severe', statement: 'Illegal with severe penalties under the Narcotic Drugs Act.', ev: 'law', cert: 'established', asOf: '2025', src: { org: 'Narcotic Drugs Act', url: '' } },
      religious_freedom: { o: 2, short: 'Moderate', statement: 'Pew rates government restrictions on religion as moderate.', ev: 'index', cert: 'established', asOf: '2022', src: 'pew' },
      ...
      health_insurance: { required: true, timing: 'before travel', statement: 'Comprehensive private health insurance is strongly advised; public facilities are stretched.', ev: 'advisory', cert: 'limited', asOf: '2025', src: { org: 'Travel-health advice', url: '' } },
...

  {
    ...
    claims: {
      ...
      antidiscrimination: { o: 1, short: 'Limited', statement: 'Constitutional equality clauses exist, but there is limited enforceable anti-discrimination protection.', ev: 'law', cert: 'limited', asOf: '2025', src: { org: 'Egyptian Constitution', url: '' } },
      disability_rights: { o: 1, short: 'CRPD + basic law', statement: 'Egypt ratified the CRPD in 2008 and has a disability law, but accessibility is limited.', ev: 'law', cert: 'established', asOf: '2025', src: 'uncrpd' },
      ...
      cannabis: { o: 0, short: 'Illegal — severe', statement: 'Illegal with severe penalties.', ev: 'law', cert: 'established', asOf: '2025', src: { org: 'Egyptian narcotics law', url: '' } },
      ...
      residence_registration: { required: true, deadlineDays: 7, timing: 'register within 7 days of arrival', statement: 'Foreigners are expected to register with authorities within about a week of arrival; hotels do this for you, but private stays may not.', ev: 'law', cert: 'limited', asOf: '2025', src: { org: 'Egyptian authorities', url: '' } },
      student_work: { required: false, timing: 'not permitted', statement: 'Student visas do not permit employment; a separate work permit is required.', ev: 'law', cert: 'limited', asOf: '2025', src: { org: 'Egyptian authorities', url: '' } },
      health_insurance: { required: true, timing: 'before travel', statement: 'Private health insurance is strongly advised; public care is basic.', ev: 'advisory', cert: 'limited', asOf: '2025', src: { org: 'Travel-health advice', url: '' } },
      medication_import: { required: false, timing: 'carry documentation', statement: 'Carry prescriptions; drones are effectively banned and some medicines are restricted.', ev: 'advisory', cert: 'limited', asOf: '2025', src: { org: 'Egyptian customs', url: '' } },
    },
  },

  {
    ...
    claims: {
      ...
      disability_rights: { o: 1, short: 'CRPD + policy', statement: 'South Africa ratified the CRPD in 2007; policy exists but physical accessibility is inconsistent.', ev: 'law', cert: 'established', asOf: '2025', src: 'uncrpd' },
      ...
      cannabis: { o: 3, short: 'Private use legal', statement: 'Private personal use and cultivation are legal (2018 Constitutional Court ruling); there is no legal retail sale.', ev: 'law', cert: 'established', asOf: '2018', src: { org: 'Constitutional Court', url: '' } },
      religious_freedom: { o: 3, short: 'Low restrictions', statement: 'Pew rates government restrictions on religion as low.', ev: 'index', cert: 'established', asOf: '2022', src: 'pew' },
...

  {
    ...
    claims: {
      ...
      antidiscrimination: { o: 0, short: 'No general protection', statement: 'There is no general anti-discrimination law, and serious concerns exist about ethnic-minority repression.', ev: 'law', cert: 'limited', asOf: '2025', src: { org: 'Human-rights reporting', url: '' } },
      disability_rights: { o: 1, short: 'CRPD + basic law', statement: 'China ratified the CRPD in 2008; accessibility is improving in major cities but uneven.', ev: 'law', cert: 'established', asOf: '2025', src: 'uncrpd' },
      ...
      cannabis: { o: 0, short: 'Illegal — severe', statement: 'Illegal with severe penalties — including for residues detectable after you return home.', ev: 'law', cert: 'established', asOf: '2025', src: { org: 'Chinese narcotics law', url: '' } },
      ...
      health_insurance: { required: true, timing: 'before enrolment', statement: 'Comprehensive insurance is required for the study visa and enrolment.', ev: 'law', cert: 'limited', asOf: '2025', src: { org: 'University requirement', url: '' } },
...

  {
    ...
    claims: {
      ...
      disability_rights: { o: 2, short: 'Strong', statement: 'Australia ratified the CRPD in 2008 and has a strong Disability Discrimination Act and the NDIS.', ev: 'law', cert: 'established', asOf: '2025', src: 'uncrpd' },
      ...
      cannabis: { o: 1, short: 'Illegal (ACT differs)', statement: 'Illegal nationally; the ACT allows small personal amounts. Medical cannabis is legal by prescription.', ev: 'law', cert: 'established', asOf: '2025', src: { org: 'State / territory law', url: '' } },
      religious_freedom: { o: 3, short: 'Low restrictions', statement: 'Pew rates government restrictions on religion as low.', ev: 'index', cert: 'established', asOf: '2022', src: 'pew' },
...

  {
    ...
    claims: {
      ...
      gender_recognition: { o: 0, short: 'Not accessible', statement: 'There is no accessible legal gender-recognition process.', ev: 'law', cert: 'limited', asOf: '2025', src: 'equaldex' },
      antidiscrimination: { o: 1, short: 'Limited', statement: 'Formal anti-discrimination protection is limited.', ev: 'law', cert: 'limited', asOf: '2025', src: { org: 'Uzbek law', url: '' } },
      disability_rights: { o: 1, short: 'CRPD + basic law', statement: 'Uzbekistan ratified the CRPD in 2021; accessibility remains limited.', ev: 'law', cert: 'established', asOf: '2025', src: 'uncrpd' },
      ...
      cannabis: { o: 1, short: 'Illegal', statement: 'Illegal; personal possession is prosecuted under Article 276 and can bring up to three years’ imprisonment.', ev: 'law', cert: 'established', asOf: '2025', src: { org: 'Criminal Code, Art. 276', url: '' } },
      ...
      residence_registration: { required: true, deadlineDays: 3, timing: 'register within 3 working days', statement: 'Foreigners must register their place of stay within about three working days of arrival; hotels do this for you.', ev: 'law', cert: 'limited', asOf: '2025', src: { org: 'Uzbek migration service', url: '' } },
      student_work: { required: false, timing: 'generally not permitted', statement: 'Student visas generally do not allow employment; work permits are separate and limited.', ev: 'law', cert: 'limited', asOf: '2025', src: { org: 'Uzbek migration service', url: '' } },
      health_insurance: { required: true, timing: 'before travel', statement: 'Private health insurance is strongly advised; public healthcare is under-resourced.', ev: 'advisory', cert: 'limited', asOf: '2025', src: { org: 'Travel-health advice', url: '' } },
      medication_import: { required: false, timing: 'declare and carry prescriptions', statement: 'Declare all medicines — some (codeine, strong psychotropics) are banned; keep prescriptions.', ev: 'advisory', cert: 'limited', asOf: '2025', src: { org: 'Uzbek customs', url: '' } },
    },
  },
]
